...
class DefaultListableBeanFactoryTests {
	...
	@Test
	public void defaultListableBeanFactoryIsResourceLoader(){
		if (lbf instanceof ResourceLoader) {
			System.out.println("defaultListableBeanFactoryIsResourceLoader");
		}else {
			System.out.println("defaultListableBeanFactoryIsResourceLoader not");
		}
	}
